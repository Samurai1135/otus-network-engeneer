...
Поскольку мы ранее создавали правило трансляции только внутренних подсетей - необходимо еще добавить правило для трансляции в BGP выбранного пула адресов
~~~
