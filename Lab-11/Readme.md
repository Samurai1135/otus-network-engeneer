...
В текущей схеме нет транзитного трафика. Тем не менее настроим фильтрацию транзитного трафика на случай появления нового провайдера:
~~~
...
~~~
Аналогичную конфигурацию применим к R14  
...
B     192.168.4.0/24 [20/0] via 10.8.0.1, 00:03:55
B     192.168.5.0/24 [20/0] via 10.8.0.1, 00:03:55
B     192.168.6.0/23 [200/0] via 10.128.254.14, 00:04:41
~~~
~~~
R15#sh ip bgp
...
B*    0.0.0.0/0 [20/0] via 10.7.0.1, 00:06:53
B     192.168.4.0/24 [200/0] via 10.128.254.15, 00:06:07
B     192.168.5.0/24 [200/0] via 10.128.254.15, 00:06:07
~~~
