...
![](https://github.com/Samurai1135/otus-network-engeneer/blob/e34151e4fcfb5a0a3900434cd8ea6b61fbb9b521/Lab-14/Pics/pic1.png)

# Задание:
- `Часть1.`Настроить GRE поверх IPSec между офисами Москва и С.-Петербург.
- `Часть2.`Настроить DMVPN поверх IPSec между Москва и Чокурдах, Лабытнанги.
- `Часть3.`Дополнительно: Для IPSec использовать CA и сертификаты.

GRE не обеспечивает шифрование. Если нам необходимо  шифрование трафика -  делаем GRE поверх IPSec или DMVPN поверх IPSec.
...
На R18 подняты Tunnel100 и Tunnel101. Будем настраивать IPSec на них.
...
crypto isakmp key MOSCOWNET address 89.20.1.14
...
Аналогично настраиваем R14, R15, R28, R27, с применением того же профиля.
### R27:  
~~~
