...
| :----------------- | :------------------- | :---------------------------------- |
|Маршрутизатор/роутер| R1              |  eth0/0.20 -- IP:10.128.20.254/24  |  
|                    |                      |  eth0/0.30 --  IP:10.128.30.254/24 |
|Маршрутизатор/роутер| R2              |  eth0/0.20 -- IP:10.128.20.254/24  |  
|                    |                      |  eth0/0.30 --  IP:10.128.30.254/24 |
|Коммутатор/Свитч 1. | S1              |  eth0/0-2 - trunk, eth1/1 - trunk  |
|Коммутатор/Свитч 2. | S2              |  eth0/0-1 - trunk, eth1/0 - access|
|Пользовательский ПК5| PC5                 |  eth0 -- IP:10.128.30.5/24         |
