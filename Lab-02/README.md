...
Стоимость портов Cost на коммутаторах равна 100, что говорит о прямом подключении к RouteBridge. Исключение составляет коммутатор Switch4(SW4), чья стоимость порта Cost = 200, т.к. между ним и RootBridge есть еще одно сетевое устройство - коммутатор Switch2(SW2) (слева по схеме) и Switch3(SW3) (справа по схеме)
